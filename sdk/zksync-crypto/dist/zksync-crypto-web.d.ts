...
* @returns {Uint8Array}
*/
export function private_key_to_pubkey_with_xy(private_key: Uint8Array): Uint8Array;
/**
...
* @returns {Uint8Array}
*/
export function rescueHashOrders(msg: Uint8Array): Uint8Array;
/**
...
* @returns {boolean}
*/
export function verify_musig(msg: Uint8Array, signature: Uint8Array): boolean;
...
export interface InitOutput {
  ...
  readonly printA: (a: number, b: number, c: number) => void;
  readonly private_key_to_pubkey: (a: number, b: number, c: number) => void;
  readonly private_key_to_pubkey_with_xy: (a: number, b: number, c: number) => void;
  ...
  readonly verify_musig: (a: number, b: number, c: number, d: number) => number;
